...
var fetchCheckpoint = function(src, target, callback) {
  ...
  src.get('_local/' + id, function(err, doc) {
    if (err && err.status === 404) {
      ...
      //Not sure why we get this on safari: returns 200, no response body
      //log("Fetch checkpoint returned no doc, retrying");
      fetchCheckpoint(src, target, callback);
      return;
    }else {
